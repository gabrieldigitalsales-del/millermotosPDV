-- =========================================================
-- PDV MILLER MOTOS - RESET COMPLETO SUPABASE
-- ATENCAO: apaga e recria somente objetos com prefixo mm_pdv_.
-- Use este SQL quando houver conflito de tipos/chaves de versoes anteriores.
-- =========================================================
...
drop view if exists public.mm_pdv_relatorio_produtos_mais_vendidos cascade;
drop view if exists public.mm_pdv_relatorio_vendas_diarias cascade;

drop table if exists public.mm_pdv_venda_itens cascade;
drop table if exists public.mm_pdv_itens_venda cascade;
drop table if exists public.mm_pdv_estoque_movimentos cascade;
...
drop table if exists public.mm_pdv_config cascade;
drop table if exists public.mm_pdv_configuracoes cascade;
drop table if exists public.mm_pdv_caixas cascade;
